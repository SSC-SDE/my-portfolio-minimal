...
export const LogoAnimation = () => {
  return (
    <div className="py-8 bg-purple-200/100 glass opacity-80">
      <div className="conrainer mx-auto">
        <div
          className="overflow-hidden [mas-image:linear-gradient(to_right,_transparent,
            _black_25%,_black_75%,_transparent)]"
        >
          <motion.div
